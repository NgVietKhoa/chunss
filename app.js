// app.js (for love.html) - No major changes needed for the PIN page itself
// This file is assumed to be for the subsequent page (love.html)
...
button.addEventListener("click", function(){
    ...
    setTimeout(()=>{
        ...
        window.location.href = "./love/love.html" // This should be the current page if app.js is for love.html
    },200)
})
